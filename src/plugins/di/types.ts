...
export const GetCommitHistoryUseCaseFactoryKey: InjectionKey<GetCommitHistoryUseCaseFactory> = Symbol('GetCommitHistoryUseCaseFactory')
export const GetIssuesUseCaseFactoryKey: InjectionKey<GetIssuesUseCaseFactory> = Symbol('GetIssuesUseCaseFactory')
export const GetPullRequestsUseCaseFactoryKey: InjectionKey<GetPullRequestsUseCaseFactory> = Symbol('GetPullRequestsUseCaseFactory')
export const GetReleasesUseCaseFactoryKey: InjectionKey<GetReleasesUseCaseFactory> = Symbol('GetReleasesUseCaseFactory')
