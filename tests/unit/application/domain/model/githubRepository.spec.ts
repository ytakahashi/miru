...
describe('RepositorySetting', () => {
  it('can initialize', () => {
    ...
    expect(actual.displayName('-')).toBe('ytakahashi-test-123_456')
    expect(
      actual.equals(new RepositorySetting('https://github.com/ytakahashi/test-123_456/'))
    ).toBeTruthy()
    expect(
      actual.equals(new RepositorySetting('https://github.com/ytakahashi/test-123_45/'))
    ).toBeFalsy()
  })
})
